...
from scraper.spiders.igedd import IGEDDSpider


class DiscloseIGEDDScraper(AddOn):
    ...
    def check_permissions(self):
        ...
        try:
            ...
            subject = f"IGEDD Scraper - Error connecting to DocumentCloud"
            content = f"Error:\n {e.__traceback__}"
    ...
    def main(self):
        ...
        self.set_message(f"Scraping IGEDD documents ({str(self.target_year)})")
        process.start()
        self.set_message("Scraping complete!")


if __name__ == "__main__":
    DiscloseIGEDDScraper().main()
